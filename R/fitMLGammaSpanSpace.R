...
##' 
##' @title Maximum likelihood estimate of evolutionary rates
...
##' @param gap.char the character to be used as the gap in the data. Default is "-".
...
##' @param init set the initial parameters for the MLE search.
