...
#   ## Computes the marginal estimate for the rates under a Bounded BM model.
#   
...
#   gamma.lik <- parallel::mclapply(1:nsites, function(site) sapply(scaled_lik_gamma_bm, function(r) lik_fn[[site]](x = r) ), mc.cores = n.cores)
# 
...
#   ## For loop is just to make the output is a vector.
